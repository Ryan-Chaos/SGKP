...
class Resnet(nn.Module):
    def __init__(self, dilate_scale=8, pretrained=True,version = 50):
...
class PSPNet(nn.Module):
    def __init__(self, num_classes, downsample_factor, backbone="resnet101", pretrained=True, aux_branch=True):
        ...
        if backbone=="resnet50":
            self.backbone = Resnet(downsample_factor, pretrained,50)
            aux_channel = 1024
            out_channel = 2048
        elif backbone=="resnet101":
            self.backbone = Resnet(downsample_factor, pretrained,101)
            aux_channel = 1024
            out_channel = 2048
